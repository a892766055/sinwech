                ...
                <div class="item <?php if($j==1) echo "active"; ?>">
                    <img src="<?php echo esc_url($theme_options['slide_image_'.$i]); ?>" class="img-responsive" alt="<?php echo esc_attr($theme_options['slide_title_'.$i]); ?>" />
                        <div class="container">
                            ...
                            <?php } ?>
                                <h1 class="hot-sale"><?php echo esc_attr($theme_options['custom_title_4'])?></h1>
                                <div class="hot-white"><?php echo esc_attr($theme_options['custom_desciption_4'])?>
                                <div class="hot-blue"></div>
                                </div>
                                <a href="#"><div class="hot-more">MORE</div></a>
                        </div>
                    </div>
                </div>
    <?php $j++; }  } ?>
