...
function kadima_customizer( $wp_customize ) {
    ...
    $wp_customize->selective_refresh->add_partial( 'kadima_options[custom_title_1]', array(
        'selector' => '.title',
        'container_inclusive' => false,
    ) );
//    $wp_customize->selective_refresh->add_partial( 'kadima_options[custom_title_1_3]', array(
//        'selector' => '.kadima-p',
//        'container_inclusive' => false,
//    ) );
//    $wp_customize->selective_refresh->add_partial( 'kadima_options[custom_title_1_4]', array(
//        'selector' => '.kadima-p2',
//        'container_inclusive' => false,
//    ) );
//    $wp_customize->selective_refresh->add_partial( 'kadima_options[custom_title_1_5]', array(
//        'selector' => '.kadiam-box-span1',
//        'container_inclusive' => false,
//    ) );
//    $wp_customize->selective_refresh->add_partial( 'kadima_options[custom_title_1_6]', array(
//        'selector' => '.kadiam-box-span2',
//        'container_inclusive' => false,
//    ) );
//    $wp_customize->selective_refresh->add_partial( 'kadima_options[custom_title_1_7]', array(
//        'selector' => '.kadiam-box-span3',
//        'container_inclusive' => false,
//    ) );
//    $wp_customize->selective_refresh->add_partial( 'kadima_options[custom_title_1_8]', array(
//        'selector' => '.kadiam-box-span4',
//        'container_inclusive' => false,
//    ) );
//    $wp_customize->selective_refresh->add_partial( 'kadima_options[custom_title_1_9]', array(
//        'selector' => '.kadiam-box-span5',
//        'container_inclusive' => false,
//    ) );
    $wp_customize->selective_refresh->add_partial( 'kadima_options[custom_title_1_2]', array(
        'selector' => '.ma>h1',
        'container_inclusive' => false,
    ) );
    $wp_customize->selective_refresh->add_partial( 'kadima_options[custom_text_2_5]', array(
        'selector' => '.custom-2-5',
        'container_inclusive' => false,
    ) );
    ...
    $wp_customize->selective_refresh->add_partial( 'kadima_options[custom_title_2]', array(
        'selector' => '.ma2>h1',
        'container_inclusive' => false,
    ) );
    $wp_customize->selective_refresh->add_partial( 'kadima_options[custom_text_3_5]', array(
        'selector' => '.cus-3-5',
        'container_inclusive' => false,
    ) );
    $wp_customize->selective_refresh->add_partial( 'kadima_options[custom_title_3]', array(
        'selector' => '.appliction-h1',
        'container_inclusive' => false,
    ) );
    $wp_customize->selective_refresh->add_partial( 'kadima_options[custom_title_4]', array(
        'selector' => '.hot-sale',
        'container_inclusive' => false,
    ) );
}
