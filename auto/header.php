...
<div>
	<!-- Header Section -->
	<div class="header_section bg" >
		<div class="container" >
			<!-- Logo & Contact Info -->
			<div class="row ">
				<div class="col-md-6 col-sm-6 col-xs-12  wl_rtl" >
					<div class="logo">
...
<!--					<p>--><?php //bloginfo( 'description' ); ?><!--</p>-->
				...
				<?php } ?>
                    ...
                    <div class="phone"><img class="phone-img" src="http://localhost/wrd-auto/wp-content/themes/auto/images/xwy_18.png">+86-15060769043</div>
				</div>
				<?php } ?>
			</div>
			<!-- /Logo & Contact Info -->
	...
	<!-- /Header Section -->
	<!-- Navigation  menus -->
	<div class="navigation_menu top"  data-spy="affix" data-offset-top="95" id="kadima_nav_top">
		<div class="container navbar-container" >
			<nav class="navbar navbar-default " role="navigation">
				...
				<div id="menu" class="collapse navbar-collapse  fr">
					<?php
						wp_nav_menu( array(
